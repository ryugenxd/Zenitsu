...
const HeroSection:React.FC = ()=>{
    return (<div className="flex justify-between items-center mx-0 px-0 text-white h-screen" id="home">
        ...
        <div className="p-3 md:max-w-[450px] md:mx-4 rounded-md backdrop-blur-[5px] shadow-xl m-3 bg-[rgba(2,3,3,0.48)] font-zen">
            ...
            <div className="flex justify-end items-center w-full">
                <a href="#profile" className="inline-flex items-center justify-center bg-[rgba(2,3,3,8)] p-3 w-[150px] rounded-md text-1xl font-bold gap-2 cursor-pointer hover:bg-[#0B4D81] transition ease-in-out  hover:shadow-xl delay-[160]"><FiFileText/> Detail</a>
            </div>
        </div>

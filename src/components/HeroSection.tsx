...
const HeroSection:React.FC = ()=>{
    return (<div id="home"  className="flex justify-between  items-center max-[1099px]:items-end mx-0 px-0 text-white h-screen relative">
        <HorizontalShadow top="0" left="0"/>
        <div className="p-3 max-[1099px]:w-full min-[1099px]:max-w-[450px] md:mx-4 rounded-md backdrop-blur-[5px] shadow-xl m-3 bg-[rgba(2,3,3,0.48)] font-zen  max-[1099px]:z-[20]">
        ...
        <div className="p-0 m-0  rounded-[1rem] w-full backdrop-blur-sm max-[1099px]:absolute">

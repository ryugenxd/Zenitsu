...
const ProfileSection = ()=>{
    return (<Element  name="profile" className="flex max-[750px]:flex-col md:mt-[3rem] md:pt-[2rem] flex-row-reverse justify-between items-center mx-0  px-0 text-white md:h-screen relative backdrop-blur-[1rem]" id="profile">
